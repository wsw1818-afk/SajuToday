...
export function generateComprehensiveFortune(
  ...
  const morningAdvicesByElement: Record<string, string[]> = {
    wood: [
      ...
      `목(木)의 성장 에너지가 아침에 가장 강합니다. 새로운 계획을 세우기 좋은 시간이에요.`,
    ...
    fire: [
      ...
      `아침에 좋아하는 음악을 틀어놓고 움직이세요. 화(火)의 에너지가 깨어납니다.`,
    ...
    earth: [
      ...
      `아침에 흙을 밟거나 정원을 거닐면 토(土)의 기운이 충전됩니다.`,
    ...
    metal: [
      ...
      `아침에 시계나 액세서리를 정리하면 금(金)의 기운이 정돈됩니다.`,
    ...
    water: [
      `물 한 잔으로 하루를 시작하세요. 수(水)의 기운이 몸을 정화합니다.`,
