...
function generateMonthlyFortune(): Array<{month: number; content: string; luck: 'good' | 'normal' | 'bad'}> {
  const monthlyHints = [
    {
      luck: 'good' as const,
      content: `【1월 운세 - 인월, 새해의 시작】
새해 첫 달인 1월은 입춘의 기운이 시작되는 시기로, 만물이 소생하는 나무의 기운이 싹트기 시작합니다. 이 달은 새로운 시작과 계획을 세우기에 가장 좋은 시기입니다.

• 사업/직장운: 연초 사업계획이나 새로운 프로젝트 시작에 좋은 운합니다. 특히 상반기 중장기 목표를 세우면 좋은 결실을 볼 수 있습니다.
• 재물운: 큰 투자보다는 종잣돈을 모으는 데 집중하세요. 불필요한 지출을 줄이고 저축 습관을 들이면 연말에 풍요로운 결과를 얻습니다.
• 건강운: 겨울철 면역력 관리가 중요합니다. 충분한 수면과 영양 섭취로 체력을 비축하세요.
• 조언: "일년지계재어춘" - 일년의 계획은 봄에 있습니다. 올해의 큰 그림을 그리세요.`
    },
    {
      luck: 'normal' as const,
      content: `【2월 운세 - 묘월, 경칩의 기운】
2월은 경칩을 지나며 동면하던 벌레들이 깨어나듯, 그동안 준비해온 일들이 서서히 결실을 보이기 시작하는 시기입니다. 나무 기운이 본격적으로 활성화됩니다.
...
• 조언: 조급함을 버리고 천천히, 그러나 꾸준히 나아가세요.`
    ...
    {
      luck: 'good' as const,
      content: `【3월 운세 - 진월, 청명의 기운】
3월은 청명과 곡우가 있는 달로, 봄기운이 절정에 달합니다. 흙와 나무의 기운이 조화를 이루어 인간관계와 사회적 활동에 매우 좋은 시기입니다.

• 사업/직장운: 협력 사업이나 파트너십 체결에 가장 좋은 달입니다. 새로운 거래처 발굴, 계약 체결에 좋은 운합니다.
...
• 조언: 사람과의 인연을 소중히 여기세요. 이 달에 맺는 인연이 올해의 귀인이 될 수 있습니다.`
    ...
    {
      luck: 'normal' as const,
      content: `【4월 운세 - 사월, 입하의 기운】
4월은 입하를 맞이하며 봄에서 여름으로 넘어가는 전환기입니다. 불 기운이 서서히 강해지며, 안정과 충전이 필요한 시기입니다.
...
• 조언: "정중동" - 고요함 속에서 움직임을 찾으세요. 외부 활동보다 내면의 충전에 집중하는 것이 좋습니다.`
    },
    {
      luck: 'good' as const,
      content: `【5월 운세 - 오월, 망종의 기운】
5월은 망종과 하지가 있는 달로, 불 기운이 절정에 달합니다. 태양의 기운이 가장 강해 재물운과 사업운이 크게 상승하는 시기입니다.

• 사업/직장운: 연중 가장 좋은 사업운입니다! 승진, 이직, 사업 확장에 매우 좋은 운합니다. 과감한 결단이 좋은 결과로 이어집니다.
• 재물운: 투자 수익이 기대됩니다. 그동안 눈여겨봤던 투자처에 적극적으로 투자해 보세요. 부수입이나 보너스 가능성도 높습니다.
• 인간관계: 사회적 인정과 명예가 따릅니다. 자신감 있게 의견을 표현하세요.
• 건강운: 불 기운이 강해 심장과 혈압 관리가 필요합니다. 과도한 음주와 자극적인 음식을 피하세요.
• 조언: "철은 뜨거울 때 두드려라" - 기회가 왔을 때 주저하지 말고 행동하세요. 이 달을 놓치지 마세요!`
    },
    {
      luck: 'bad' as const,
      content: `【6월 운세 - 미월, 소서의 기운】
6월은 소서와 대서가 있는 무더운 시기로, 흙와 불의 기운이 충돌합니다. 주의와 신중함이 필요한 달입니다.
...
• 조언: "여름에 땀 흘리면 겨울에 눈물 흘리지 않는다" - 어려운 시기지만 묵묵히 최선을 다하세요. 고생 끝에 낙이 옵니다.`
    ...
    {
      luck: 'good' as const,
      content: `【7월 운세 - 신월, 입추의 기운】
7월은 입추를 맞이하며 금속 기운이 시작됩니다. 수확과 결실의 기운이 감돌아 그동안의 노력이 빛을 발하는 시기입니다.
...
• 조언: "가을 추수는 봄 씨앗에서 시작된다" - 지금의 성공은 과거 노력의 결과입니다. 감사하는 마음을 가지세요.`
    ...
    {
      luck: 'normal' as const,
      content: `【8월 운세 - 유월, 백로의 기운】
8월은 백로와 추분이 있는 달로, 금속 기운이 강해집니다. 가족과 함께하며 내적 평화를 찾는 시기입니다.
...
• 조언: "가화만사성" - 가정이 화목해야 만사가 성합니다. 가족과의 유대를 강화하세요.`
    },
    {
      luck: 'good' as const,
      content: `【9월 운세 - 술월, 한로의 기운】
9월은 한로와 상강이 있는 달로, 흙와 금속의 조화가 이루어집니다. 학업과 자기계발에 최적의 시기입니다.

• 사업/직장운: 새로운 기술이나 지식 습득에 좋습니다. 자격증 시험, 교육 프로그램 참여가 커리어에 도움이 됩니다.
• 재물운: 자기투자가 미래의 재물을 가져옵니다. 교육비나 자기계발 비용은 아끼지 마세요.
• 학업운: 매우 좋은 운! 시험 합격, 학업 성취에 좋습니다. 집중력이 높아져 공부 효율이 극대화됩니다.
• 건강운: 정신적으로 명료해지는 시기입니다. 명상이나 독서로 마음을 수양하세요.
• 조언: "배움에는 때가 없다" - 끊임없이 배우고 성장하세요. 이 달의 배움이 내년의 성공을 만듭니다.`
    },
    {
      luck: 'bad' as const,
      content: `【10월 운세 - 해월, 입동의 기운】
10월은 입동을 맞이하며 물 기운이 시작됩니다. 언행에 주의가 필요하고, 말로 인한 문제가 생기기 쉬운 시기입니다.

• 사업/직장운: 말 때문에 생기는 문제에 주의하세요! 불필요한 말, 험담, 비밀 누설이 문제를 일으킬 수 있습니다. 중요한 계약이나 협상은 신중하게 진행하세요.
...
• 조언: "말 한마디로 천 냥 빚을 갚는다" - 말의 무게를 알고 신중하게 행동하세요. 침묵이 금인 시기입니다.`
    ...
    {
      luck: 'good' as const,
      content: `【11월 운세 - 자월, 대설의 기운】
11월은 대설과 동지가 있는 달로, 물 기운이 절정에 달합니다. 한 해를 마무리하고 성과를 정리하기 좋은 시기입니다.
...
• 조언: "유종의 미를 거두라" - 시작이 좋았으면 끝도 좋아야 합니다. 마지막까지 최선을 다하세요.`
    },
    {
      luck: 'normal' as const,
      content: `【12월 운세 - 축월, 소한의 기운】
12월은 소한과 대한이 있는 한 해의 마지막 달로, 흙와 물의 기운이 어우러집니다. 새해를 준비하고 계획을 세우는 시기입니다.
...
• 조언: "온고지신" - 옛것을 익히고 새것을 알아가세요. 지난 한 해를 돌아보며 내년의 성장을 준비하세요.`
    },
  ];
...
export function generateYearlyFortune(birthDate: string, dayMaster: string, targetDate: Date = new Date()) {
  ...
  const yearName = `${yearInfo.stem}${yearInfo.branch}년`;
  ...
  const elementNames: Record<string, string> = { '목': '나무', '화': '불', '토': '흙', '금': '금속', '수': '물' };
...
${currentYear}년 ${yearName}은 당신에게 정재의 해입니다. 정재는 정당한 노력으로 얻는 재물을 상징하며, 올해는 재물운이 크게 상승합니다.
...
${currentYear}년 ${yearName}은 당신에게 편재의 해입니다. 편재는 예상치 못한 재물, 투자 수익, 사업 이익을 상징합니다.
...
${currentYear}년 ${yearName}은 당신에게 비견의 해입니다. 비견은 나와 같은 오행으로, 경쟁자나 동료를 의미합니다.
...
${currentYear}년 ${yearName}은 당신에게 겁재의 해입니다. 겁재는 재물의 손실이나 예기치 않은 지출을 암시합니다.
...
${currentYear}년 ${yearName}은 당신에게 식신의 해입니다. 식신은 먹거리와 풍요를 상징하며, 안정적인 재물 증가가 기대됩니다.
...
${currentYear}년 ${yearName}은 당신에게 상관의 해입니다. 상관은 창의력과 표현력을 상징하며, 새로운 방식으로 재물을 얻을 수 있습니다.
...
${currentYear}년 ${yearName}은 당신에게 정관의 해입니다. 정관은 명예와 지위를 상징하며, 승진이나 직책에 따른 재물 증가가 기대됩니다.
...
정관의 해에는 바른 길를 걷는 것이 중요합니다. 편법이나 불법적인 재테크는 피하고, 정당한 방법으로 재물을 모으세요.`,

    '편관': `【편관의 해 - 도전과 성취】

${currentYear}년 ${yearName}은 당신에게 편관의 해입니다. 편관은 도전과 압박을 상징하며, 어려움을 극복하면 큰 성취가 있습니다.
...
${currentYear}년 ${yearName}은 당신에게 정인의 해입니다. 정인은 학문과 부동산을 상징하며, 관련 분야에서 재물운이 좋습니다.
...
${currentYear}년 ${yearName}은 당신에게 편인의 해입니다. 편인은 변화와 특수한 재능을 상징하며, 색다른 방식으로 재물이 들어올 수 있습니다.
...
겁재의 해에는 참을성자가 중요합니다. 급하게 움직이지 말고 때를 기다리세요.`,
...
인연은 예측할 수 없습니다. 열린 마음으로 다양한 만남에 임하세요.`,
  ...
  const healthFortunes: Record<string, string> = {
    '목': `【나무 기운의 해 - 간과 담 건강 주의】

${currentYear}년은 나무 기운이 강한 해입니다. 나무 기운은 간과 담, 그리고 눈과 근육을 관장해요.
...
${currentYear}년은 불 기운이 강한 해입니다. 불 기운은 심장과 소장, 그리고 혀와 혈관을 관장해요.
...
${currentYear}년은 흙 기운이 강한 해입니다. 흙 기운은 비장과 위장, 그리고 입과 근육을 관장해요.
...
환절기의 기운이 강한 해이므로 변화에 적응하는 것이 중요합니다.`,
    ...
    '금': `【금속 기운의 해 - 폐와 대장 건강 주의】

${currentYear}년은 금속 기운이 강한 해입니다. 금속 기운은 폐와 대장, 그리고 코와 피부를 관장해요.
...
가을의 기운이 강한 해이므로 결실을 거두되 건조함에 주의하세요.`,
    ...
    '수': `【물 기운의 해 - 신장과 방광 건강 주의】

${currentYear}년은 물 기운이 강한 해입니다. 물 기운은 신장과 방광, 그리고 귀와 뼈를 관장해요.
...
겁재의 해에는 인내와 양보가 중요합니다. 이해관계가 얽힌 일은 서면으로 명확히 하세요.`,
  ...
  return {
    summary: `${currentYear}년 ${yearName}은 ${dayMaster} 일간에게 ${tenGod}(${tenGod === '비견' || tenGod === '겁재' ? '비겁' : tenGod})의 해입니다. ${fortune.summary}`,
    score: fortune.score,
    yearInfo: {
      year: currentYear,
      name: yearName,
...
const TOJEONG_FORTUNES: Array<{
  ...
  {
    name: '건위천',
    fortune: `하늘이 높고 넓으니 만사형통하는 매우 좋은 운의 상입니다. 건괘는 64괘 중 첫 번째로, 순수한 양의 기운이 충만하여 하늘을 상징합니다.

올해는 마치 용이 하늘로 승천하는 비룡재천의 기운을 받으셨으니, 무슨 일이든 적극적으로 추진하면 큰 성과를 거두실 수 있습니다. 사업가는 새로운 사업 확장의 기회가, 직장인은 승진과 인정의 기회가 찾아옵니다.

특히 봄과 가을에 좋은 기회가 많으니 놓치지 마시고, 귀인의 도움을 받아 뜻을 펼치실 수 있습니다. 다만 너무 높이 오르면 내려올 일만 남는 법, 정상에 서더라도 겸손함을 잃지 않는 것이 오래도록 복을 누리는 비결입니다.`,
    advice: `"항룡유회" - 너무 높이 오른 용은 후회가 있다는 뜻입니다. 성공할수록 더욱 낮은 자세로 주변을 살피고, 베풀면 더 큰 복이 돌아옵니다. 교만은 화를 부르고, 겸손은 복을 부릅니다. 윗사람에게는 공경을, 아랫사람에게는 은혜를 베푸세요.`,
    lucky: 'great',
  },
  {
    name: '곤위지',
    fortune: `대지의 덕을 받으셨으니, 땅처럼 낮은 자세로 내실을 다지는 것이 좋은 해입니다. 곤괘는 순수한 음의 기운으로 어머니 대지를 상징하며, 만물을 품고 기르는 너그러움을 뜻합니다.
...
농부가 봄에 씨를 뿌리고 가을 수확을 기다리듯, 조급해하지 않고 때를 기다리는 지혜가 필요합니다. 주변 사람들과의 관계에서도 포용력을 발휘하시면 귀한 조력자를 얻게 됩니다.`,
    advice: `"후덕재물" - 두터운 덕이 만물을 싣는다는 뜻입니다. 인내하고 기다리면 반드시 때가 오니 조급해하지 마세요. 앞에 나서기보다 뒤에서 받쳐주는 역할에 충실하면, 오히려 더 큰 인정을 받습니다. 가정의 화목을 먼저 챙기세요.`,
    lucky: 'good',
  },
  {
    name: '수뢰둔',
    fortune: `새싹이 땅을 뚫고 나오려는 상이니, 초창기의 어려움이 있으나 꾸준히 나아가면 결국 성공할 수 있습니다. 둔괘는 만물이 처음 생겨나는 때의 어려움을 상징합니다.
...
특히 상반기에 어려움이 집중될 수 있으나, 하반기로 갈수록 상황이 나아집니다. 새로운 일을 시작했다면 초반의 혼란을 잘 견디고, 기존의 일을 하고 있다면 기본에 충실하세요. 비가 온 뒤에 땅이 굳어지듯, 어려움을 극복하면 더 단단해집니다.`,
    advice: `"천하만사 시작이 반"이라 했으니, 어려울 때일수록 초심을 잃지 말고 기본에 충실하세요. 무리하게 확장하지 말고 지금 있는 것을 지키는 데 집중하세요. 좋은 조력자를 찾되 급하게 서두르지 마세요. 때가 되면 귀인이 나타납니다.`,
    lucky: 'normal',
  },
  {
    name: '산수몽',
    fortune: `어린아이가 가르침을 받는 상이니, 배움의 해입니다. 몽괘는 산 아래 샘물이 있어 아직 방향을 정하지 못하고 흐르는 모습을 상징하며, 깨우침을 통해 올바른 길을 찾아가는 것을 뜻합니다.
...
또한 인생의 멘토나 스승을 만날 수 있는 시기입니다. 나이 많은 어른이나 경험 많은 선배의 조언에 귀 기울이세요. 때로는 책 한 권이 인생을 바꾸기도 하니, 독서도 소홀히 하지 마세요. 모르는 것을 부끄러워하지 말고, 배움에 겸손하세요.`,
    advice: `"학이시습" - 배우고 때때로 익히면 기쁘지 아니한가. 스승이나 선배의 조언을 귀담아 듣고 실천하세요. 모르면서 아는 척하는 것이 가장 위험합니다. 겸손하게 물으면 누구라도 가르쳐줄 것입니다. 배움에는 나이도 체면도 없습니다.`,
    lucky: 'good',
  },
  {
    name: '화천대유',
    fortune: `하늘 위에 태양이 있어 세상을 밝게 비추는 상이니, 크게 얻는 매우 좋은 운의 해입니다. 대유괘는 하늘과 불이 만나 밝은 기운이 충만함을 상징합니다.
...
다만 너무 많이 가지면 잃을 것도 많아지는 법, 재물이 모이는 만큼 베풀 줄도 알아야 합니다. 주변의 어려운 사람을 돕고, 사회에 환원하는 마음을 가지면 복이 끊이지 않습니다. 화려한 성공에 취해 본심을 잃지 않도록 주의하세요.`,
    advice: `"유무상통" - 있는 사람이 없는 사람과 나누면 모두가 풍요로워집니다. 많이 얻을수록 많이 베푸세요. 베풀면 더 큰 복이 돌아오고, 움켜쥐면 가진 것마저 잃습니다. 재물은 흐르는 물과 같아서 막으면 썩고 흐르면 깨끗해집니다.`,
    lucky: 'great',
  },
  {
    name: '지산겸',
    fortune: `산이 땅 아래 있으니 겸손의 덕을 상징합니다. 겸괘는 64괘 중 유일하게 모든 효가 길한 괘로, 겸손하면 반드시 복이 온다는 것을 보여줍니다.
...
낮은 자세로 일하면 인정받을 수 있으며, 오히려 드러내지 않을수록 더 빛납니다. 겸손은 나약함이 아니라 진정한 강함입니다. 실력을 쌓되 조용히, 성과를 내되 겸허하게, 칭찬받되 교만하지 않게. 이렇게 하면 누구나 당신을 존경하고 따를 것입니다.`,
    advice: `"겸수익" - 겸손하면 이로움을 받는다는 뜻입니다. 자만하지 말고 한결같이 노력하세요. 성공해도 초심을 잃지 말고, 높은 자리에 올라도 아랫사람을 하대하지 마세요. 한 발 물러서면 오히려 넓은 길이 열립니다.`,
    lucky: 'good',
  },
  {
    name: '택지췌',
    fortune: `연못이 땅 위에 있어 물이 모이는 상이니, 사람과 기회가 모이는 매우 좋은 운의 해입니다. 췌괘는 모임과 결집을 상징하며, 흩어진 것들이 하나로 모여 큰 힘이 됨을 뜻합니다.
...
인맥을 넓히기에도 좋은 해입니다. 모임에 참석하고, 새로운 사람을 만나며, 인연을 소중히 하세요. 특히 오래된 친구나 지인이 귀인이 될 수 있으니, 옛 인연도 돌아보세요. 결혼, 합자, 제휴 등 중요한 결합에 길한 해입니다.`,
    advice: `"화합위본" - 화합이 근본이라는 뜻입니다. 좋은 인연을 소중히 하고, 사람을 모으는 데 힘쓰세요. 혼자 가면 빨리 가지만, 함께 가면 멀리 갑니다. 리더십을 발휘해야 할 때이니, 주변을 이끌되 독단은 피하세요.`,
    lucky: 'great',
  },
  {
    name: '산지박',
    fortune: `산이 무너져 땅으로 돌아가는 상이니, 주의가 필요한 해입니다. 박괘는 양의 기운이 소진되어 음이 지배하는 때를 상징하며, 쇠퇴와 손실을 경고합니다.

올해는 무리하지 말고 현상 유지에 집중하세요. 새로운 사업이나 투자는 삼가고, 확장보다 수성에 힘쓰세요. 지금 가진 것을 지키는 것이 최선의 전략입니다.

그러나 낙심할 것은 없습니다. 박괘 다음에는 복괘가 오니, 어둠이 지나면 반드시 새벽이 옵니다. 이 시기를 잘 견디면 내년에는 운이 상승합니다. 조용히 내면을 다스리고, 건강을 챙기며, 가족과 시간을 보내세요. 때로는 멈춤도 전진입니다.`,
    advice: `"고진감래" - 쓴 것이 다하면 단 것이 온다는 뜻입니다. 새로운 일은 미루고 기존 일에 충실하세요. 사람을 경계하되 의심하지는 말고, 재물을 아끼되 인색하지는 마세요. 힘든 시기를 현명하게 보내면 더 단단해져 돌아옵니다.`,
    lucky: 'caution',
  },
];
...
※ 옛말: "부귀재천 근면재인" - 부귀는 하늘에 달렸지만 근면함은 사람에게 달렸습니다.`;
  } else if (luckyLevel === 'good') {
    return `【토정비결 재물운 - 좋은 운】
...
※ 옛말: "근검절약이 치부지본" - 부지런하고 검소함이 부를 이루는 근본입니다.`;
...
▶ 편재:
횡재는 기대하기 어렵습니다. 복권이나 투기성 투자는 삼가고 바른 길를 걸으세요.
...
※ 옛말: "안분지족" - 분수를 알고 만족할 줄 알면 근심이 없습니다.`;
  } else {
    return `【토정비결 재물운 - 주의】
...
※ 옛말: "등용문" - 용문에 오르니 만사형통입니다.`;
  } else if (luckyLevel === 'good') {
    return `【토정비결 직업운 - 좋은 운】
...
▶ 사업자:
공격적인 투자나 확장보다 수성에 집중하세요. 기존 고객 관리와 품질 향상에 주력하면 좋겠습니다.
...
※ 옛말: "안분수기" - 분수를 알고 자기를 지키면 탈이 없습니다.`;
  } else {
    return `【토정비결 직업운 - 주의】
...
※ 옛말: "가화만사성" - 집안이 화목하면 모든 일이 이루어집니다.`;
  } else if (luckyLevel === 'good') {
    return `【토정비결 가정/인연운 - 좋은 운】
...
※ 옛말: "천륜지락" - 가족과 함께하는 즐거움을 소중히 여기세요.`;
  } else {
    return `【토정비결 가정/인연운 - 주의】

"${gweName}" 괘를 받으신 분의 올해 가정운은 조심이 필요합니다. 토정비결에서는 "차가운 북풍이 부는 상"으로 풀이합니다.

▶ 가족 갈등:
가족 간 오해나 다툼이 있을 수 있습니다. 참을성자를 마음에 새기고, 감정적인 대화는 피하세요.
...
당신의 2026년 병오년 괘는 "${fortune.name}"입니다.

▶ 괘상 해설:
${fortune.fortune}

▶ 전체 운세 등급: ${fortune.lucky === 'great' ? '매우 좋은 운' : fortune.lucky === 'good' ? '좋은 운' : fortune.lucky === 'normal' ? '평' : '주의'}
...
function generateTojeongMonthlyFortune(yearLuck: 'great' | 'good' | 'normal' | 'caution'): Array<{month: number; content: string; luck: 'good' | 'normal' | 'bad'}> {
  ...
  const baseContents: Record<number, { title: string; base: string }> = {
    1: { title: '정월', base: '새해 첫 달로 만물이 소생하는 시기입니다. 입춘과 우수가 있어 새로운 시작의 기운이 강합니다.' },
    2: { title: '이월', base: '경칩과 춘분이 있는 달로, 동면하던 만물이 깨어납니다. 봄기운이 본격화되는 시기입니다.' },
    3: { title: '삼월', base: '청명과 곡우가 있어 봄이 절정에 달합니다. 만물이 생동하는 시기입니다.' },
    4: { title: '사월', base: '입하와 소만이 있어 여름이 시작됩니다. 봄에서 여름으로 전환되는 시기입니다.' },
    5: { title: '오월', base: '망종과 하지가 있어 불 기운가 절정입니다. 낮이 가장 긴 시기입니다.' },
    6: { title: '유월', base: '소서와 대서가 있어 무더위가 기승합니다. 양기가 극에 달하는 시기입니다.' },
    7: { title: '칠월', base: '입추와 처서가 있어 가을이 시작됩니다. 수확을 준비하는 시기입니다.' },
    8: { title: '팔월', base: '백로와 추분이 있어 가을이 깊어갑니다. 추석이 있는 풍요의 달입니다.' },
    9: { title: '구월', base: '한로와 상강이 있어 서늘함이 찾아옵니다. 결실을 마무리하는 시기입니다.' },
    10: { title: '시월', base: '입동과 소설이 있어 겨울이 시작됩니다. 내면을 돌아보는 시기입니다.' },
    11: { title: '동짓달', base: '대설과 동지가 있어 밤이 가장 긴 시기입니다. 한 해를 마무리하며 성찰합니다.' },
    12: { title: '섣달', base: '소한과 대한이 있어 추위가 절정입니다. 새해를 준비하는 시기입니다.' },
  };
...
• 정재: 본업에서의 수입이 증가합니다. 급여 인상, 보너스, 성과급 등이 기대됩니다.
• 편재: 투자나 부업에서 예상치 못한 수익이 있을 수 있습니다. 재테크에 관심을 가지세요.
...
• 정재: 현재 수입이 유지됩니다. 성실하게 일하면 그에 합당한 보상이 있습니다.
• 편재: 큰 횡재보다 작은 행운들이 이어집니다. 욕심내지 않는 것이 현명합니다.
...
• 정재: 수입과 지출의 균형을 맞추세요. 현재 상태를 유지하는 데 집중하세요.
• 편재: 고위험 투자는 피하고 안전자산 위주로 운용하세요.
...
// 병은 불, 오는 말띠이며 불의 기운
// 오와의 관계: 삼합(인오술-화국), 육합(미), 상충(자), 상해(축), 상형(오-자형)
const ANIMAL_YEARLY_FORTUNE: Record<number, {
  ...
  2: { // 개띠 - 오술 반합(화국의 일부)
    overall: '2026년은 개띠에게 발전의 해입니다. 오술 반합으로 불의 좋은 기운이 있습니다.',
    score: 82,
  ...
  4: { // 쥐띠 - 오자충 상충!
    overall: '2026년은 쥐띠에게 주의가 필요한 해입니다. 오자충으로 말띠 해와 상충합니다.',
    score: 58,
  ...
  5: { // 소띠 - 오축상해
    ...
    advice: '참을성자를 새기세요. 겸손과 인내가 필요한 해입니다.',
  },
  6: { // 호랑이띠 - 인오술 삼합(화국)!
    overall: '2026년은 호랑이띠에게 대길의 해입니다! 인오술 삼합으로 불의 강한 기운이 돕습니다.',
    score: 88,
...
function generateDetailedMonthContent(
  ...
  if (relation === 'samhap') {
    return `【${month}월 ${monthNames[month - 1]} 운세 - 삼합 대길】

${animalName}띠에게 ${month}월은 삼합의 기운이 작용하는 매우 좋은 운의 달입니다.
...
• 조언: 삼합의 기운을 십분 활용하세요. 중요한 결정, 새로운 시작, 도전에 과감하게 임하면 좋은 결과가 따릅니다.`;
  ...
  if (relation === 'yukhap') {
    return `【${month}월 ${monthNames[month - 1]} 운세 - 육합 길】

${animalName}띠에게 ${month}월은 육합의 기운이 작용하는 좋은 운한 달입니다.
...
• 조언: 육합의 기운은 합을 의미합니다. 혼자보다 함께할 때 더 좋은 결과를 얻을 수 있습니다. 화합과 협력을 중시하세요.`;
  }

  if (relation === 'chung') {
    return `【${month}월 ${monthNames[month - 1]} 운세 - 상충 주의】

${animalName}띠에게 ${month}월은 상충의 기운이 작용하는 주의가 필요한 달입니다.
이 달의 지지 ${monthBranch}(${monthElement})가 당신의 띠와 충하여 변동과 갈등의 기운이 있습니다.
...
• 조언: 충의 기운은 변화와 이동을 암시합니다. 이사, 여행, 큰 결정은 피하는 것이 좋습니다. 붉은색 소품을 지니면 액막이에 도움이 됩니다. 겸손하고 신중하게 행동하세요.`;
  }

  // normal
  const normalContents: Record<number, string> = {
    1: `【${month}월 ${monthNames[month - 1]} 운세 - 인월】

${animalName}띠에게 ${month}월은 새해의 시작과 함께 새로운 기운이 시작되는 달입니다.
인의 나무 기운이 만물을 소생시키듯, 새로운 계획과 시작에 적합합니다.
...
• 조언: 일년지계재어춘 - 봄의 계획이 일년을 좌우합니다. 체계적인 목표와 계획을 세우세요.`,

    2: `【${month}월 ${monthNames[month - 1]} 운세 - 묘월】

${animalName}띠에게 ${month}월은 봄기운이 본격적으로 시작되는 생동감 넘치는 달입니다.
묘의 나무 기운이 활발해지며 성장과 발전의 기운이 흐릅니다.
...
• 조언: 봄의 새싹처럼 서서히 성장하세요. 조급함을 버리고 꾸준히 노력하면 좋은 결실을 맺습니다.`,
    ...
    3: `【${month}월 ${monthNames[month - 1]} 운세 - 진월】

${animalName}띠에게 ${month}월은 봄기운이 절정에 달하는 역동적인 달입니다.
진은 용의 지지로, 변화와 도약의 기운이 강합니다.
...
• 조언: 용처럼 과감하게 도전하되, 현실적인 판단도 잊지 마세요. 기회를 잡을 준비를 하세요.`,
    ...
    4: `【${month}월 ${monthNames[month - 1]} 운세 - 사월】

${animalName}띠에게 ${month}월은 봄에서 여름으로 넘어가는 전환기입니다.
사의 불 기운이 서서히 강해지며 열정과 활력이 넘칩니다.
...
• 조언: 정중동 - 고요함 속에서 내실을 다지세요. 외부 활동보다 내면의 충전이 필요한 시기입니다.`,

    5: `【${month}월 ${monthNames[month - 1]} 운세 - 오월】

${animalName}띠에게 ${month}월은 불 기운이 가장 강한 한 해의 정점입니다.
오는 말의 지지로, 열정과 에너지가 절정에 달합니다.
...
• 조언: 철은 뜨거울 때 두드려라 - 기회가 왔을 때 주저하지 마세요. 열정을 현명하게 활용하세요.`,
    ...
    6: `【${month}월 ${monthNames[month - 1]} 운세 - 미월】

${animalName}띠에게 ${month}월은 무더운 여름의 한복판, 휴식과 충전이 필요한 달입니다.
미의 흙 기운이 열기를 식히며 안정을 가져옵니다.
...
• 조언: 더위를 피해 그늘에서 쉬듯, 이 달은 무리하지 말고 충전하세요. 재충전이 하반기 성공의 밑거름이 됩니다.`,
    ...
    7: `【${month}월 ${monthNames[month - 1]} 운세 - 신월】

${animalName}띠에게 ${month}월은 가을의 시작과 함께 새로운 기운이 도래하는 달입니다.
신의 금속 기운이 수확과 결실의 기운을 가져옵니다.
...
• 조언: 가을은 수확의 계절입니다. 그동안의 노력에 감사하며 결실을 거두세요. 새로운 도전도 좋습니다.`,
    ...
    8: `【${month}월 ${monthNames[month - 1]} 운세 - 유월】

${animalName}띠에게 ${month}월은 가을이 깊어지는 풍요로운 달입니다.
유의 금속 기운이 결실과 풍요를 상징합니다.
...
• 조언: 가화만사성 - 가정의 화목이 모든 일의 근본입니다. 가족에게 감사를 표현하세요.`,

    9: `【${month}월 ${monthNames[month - 1]} 운세 - 술월】

${animalName}띠에게 ${month}월은 가을이 저물어가는 성찰의 달입니다.
술의 흙 기운이 내면의 성장과 학습을 돕습니다.
...
• 조언: 배움에는 때가 없습니다. 이 달의 학습과 성찰이 내년의 발전으로 이어집니다.`,
    ...
    10: `【${month}월 ${monthNames[month - 1]} 운세 - 해월】

${animalName}띠에게 ${month}월은 겨울의 시작과 함께 내면을 돌아보는 달입니다.
해의 물 기운이 지혜와 통찰을 가져옵니다.
...
• 조언: 침묵이 금인 시기입니다. 말보다 행동으로 보여주고, 신중하게 처신하세요.`,
    ...
    11: `【${month}월 ${monthNames[month - 1]} 운세 - 자월】

${animalName}띠에게 ${month}월은 한 해를 마무리하고 성과를 정리하는 달입니다.
자의 물 기운이 지혜와 마무리의 힘을 줍니다.
...
• 조언: 유종의 미를 거두세요. 시작이 좋았으면 끝도 좋아야 합니다. 마무리에 최선을 다하세요.`,

    12: `【${month}월 ${monthNames[month - 1]} 운세 - 축월】

${animalName}띠에게 ${month}월은 한 해의 마지막 달로, 새해를 준비하는 시기입니다.
축의 흙 기운이 안정과 준비를 돕습니다.
...
• 조언: 온고지신 - 옛것을 익히고 새것을 배우세요. 지난 한 해를 돌아보며 내년의 성장을 준비하세요.`,
  };
...
function generateDetailedAnimalWealth(animalIndex: number, score: number, yearElement: string): string {
  ...
  // 점수 구간별 상세 풀이
  if (score >= 85) {
    return `【${animalName}띠 재물운 - 매우 좋은 운】

2026년 병오년은 ${animalName}띠에게 재물운이 크게 상승하는 해입니다. ${yearElement}의 기운이 강하게 작용하여 금전적 행운이 따릅니다.

▶ 정재운: 직장이나 사업에서 안정적인 수입이 늘어납니다. 특히 상반기에 급여 인상이나 보너스를 기대할 수 있습니다. 꾸준히 쌓아온 실력이 금전적 보상으로 이어지는 시기입니다.

▶ 편재운: 투자나 부업에서 예상치 못한 수익을 얻을 가능성이 높습니다. 부동산, 주식, 코인 등 재테크에서 좋은 결과를 기대할 수 있으나, 지나친 욕심은 경계해야 합니다.
...
※ 조언: "물이 깊어야 큰 물고기가 산다"는 말처럼, 단기 이익보다 장기적인 재산 형성에 집중하세요.`;
    ...
    return `【${animalName}띠 재물운 - 좋은 운】

2026년 병오년 ${animalName}띠의 재물운은 안정적으로 상승하는 흐름입니다. ${yearElement}의 기운이 조화롭게 작용합니다.

▶ 정재운: 본업에서의 수입은 꾸준히 유지됩니다. 큰 변동 없이 안정적인 금전 흐름이 예상되며, 성실한 노력이 급여나 매출 증가로 이어질 수 있습니다.

▶ 편재운: 횡재보다는 노력에 비례한 수익이 기대됩니다. 무리한 투자보다 안정적인 저축이나 적금을 권합니다. 소액 투자는 긍정적인 결과를 가져올 수 있습니다.
...
※ 조언: "티끌 모아 태산"이라는 속담처럼, 작은 절약이 모여 큰 재산이 됩니다. 불필요한 소비를 줄이세요.`;
    ...
    return `【${animalName}띠 재물운 - 평】

2026년 병오년 ${animalName}띠의 재물운은 평온한 흐름을 보입니다. ${yearElement}의 영향으로 큰 변동 없이 현상 유지가 예상됩니다.

▶ 정재운: 수입은 현재 수준을 유지합니다. 급격한 상승은 없지만 감소도 없으니 안정적인 생활이 가능합니다. 본업에 충실하며 실력을 쌓는 시기로 삼으세요.

▶ 편재운: 투기성 투자는 삼가고 원금 보장 상품 위주로 운용하세요. 새로운 사업 시작보다 기존 일에 집중하는 것이 현명합니다.
...
※ 조언: "급할수록 돌아가라"는 말을 기억하세요. 무리한 재테크보다 안전한 방법을 선택하세요.`;
    ...
    return `【${animalName}띠 재물운 - 주의】

2026년 병오년 ${animalName}띠는 재물운에 주의가 필요한 해입니다. ${yearElement}의 기운이 충돌하여 금전 손실 위험이 있습니다.

▶ 정재운: 수입 감소나 예상치 못한 지출이 발생할 수 있습니다. 지금까지의 수입원을 잘 지키고, 새로운 수입원 확보에 노력하세요.

▶ 편재운: 올해는 투자에 신중해야 합니다. 주식, 코인, 부동산 등 고위험 투자는 피하고, 원금 손실 위험이 없는 안전자산 위주로 운용하세요.

▶ 손재 주의: 사기, 도난, 분실에 각별히 조심하세요. 큰 금액의 현금 소지는 피하고, 중요한 계약은 전문가와 상담 후 진행하세요.
...
function generateDetailedAnimalCareer(animalIndex: number, score: number, yearElement: string): string {
  ...
  if (score >= 85) {
    return `【${animalName}띠 직장/사업운 - 매우 좋은 운】

2026년 병오년은 ${animalName}띠에게 직장과 사업 모두에서 큰 성과를 기대할 수 있는 해입니다. ${yearElement}의 기운이 성공을 이끕니다.
...
※ 조언: 리더십을 발휘하되 겸손함을 잃지 마세요. "높은 나무에 바람이 거세다"는 것을 기억하세요.`;
    ...
    return `【${animalName}띠 직장/사업운 - 좋은 운】

2026년 병오년 ${animalName}띠의 직장/사업운은 순조로운 상승세입니다. ${yearElement}의 기운이 조화롭게 작용합니다.
...
※ 조언: "천 리 길도 한 걸음부터"라는 말처럼, 작은 성과들이 모여 큰 성공이 됩니다.`;
    ...
    return `【${animalName}띠 직장/사업운 - 평】

2026년 병오년 ${animalName}띠의 직장/사업운은 현상 유지의 흐름입니다. ${yearElement}의 영향으로 안정을 추구하는 것이 현명합니다.
...
※ 조언: "참을성자 세 번이면 살인도 면한다"는 말을 기억하세요. 인내가 필요한 해입니다.`;
  } else {
    return `【${animalName}띠 직장/사업운 - 주의】

2026년 병오년 ${animalName}띠는 직장과 사업에서 변동이 예상되는 해입니다. ${yearElement}의 기운이 충돌하여 신중함이 필요합니다.
...
function generateDetailedAnimalLove(animalIndex: number, score: number, yearElement: string): string {
  ...
  if (score >= 80) {
    return `【${animalName}띠 애정운 - 매우 좋은 운】

2026년 병오년은 ${animalName}띠에게 사랑이 꽃피는 해입니다. ${yearElement}의 열정적인 기운이 인연을 이끕니다.
...
※ 조언: "사랑은 주는 것"이라는 말을 기억하세요. 받는 것보다 주는 것에 집중하면 더 큰 사랑이 돌아옵니다.`;
    ...
    return `【${animalName}띠 애정운 - 좋은 운】

2026년 병오년 ${animalName}띠의 애정운은 순조로운 흐름입니다. ${yearElement}의 기운이 조화로운 인연을 가져옵니다.
...
※ 조언: "말 한마디로 천 냥 빚을 갚는다"고 합니다. 따뜻한 말 한마디가 관계를 더욱 깊게 합니다.`;
    ...
    return `【${animalName}띠 애정운 - 평】

2026년 병오년 ${animalName}띠의 애정운은 평온한 흐름입니다. ${yearElement}의 영향으로 급격한 변화보다 현상 유지가 예상됩니다.
...
※ 조언: "가까운 곳에 인연이 있다"고 합니다. 먼 곳보다 가까운 사람에게 관심을 기울여 보세요.`;
    ...
    return `【${animalName}띠 애정운 - 주의】

2026년 병오년 ${animalName}띠는 애정운에 주의가 필요한 해입니다. ${yearElement}의 기운이 충돌하여 갈등이 예상됩니다.
...
function generateDetailedAnimalHealth(animalIndex: number, score: number, yearElement: string): string {
  ...
  if (score >= 80) {
    return `【${animalName}띠 건강운 - 좋은 운】

2026년 병오년은 ${animalName}띠에게 건강운이 좋은 해입니다. ${yearElement}의 기운이 활력을 더해줍니다.
...
※ 조언: "건강이 재산이다"는 말을 기억하세요. 좋은 건강운을 유지하기 위해 꾸준히 관리하세요.`;
    ...
    return `【${animalName}띠 건강운 - 평】

2026년 병오년 ${animalName}띠의 건강운은 평온한 흐름입니다. ${yearElement}의 영향으로 큰 탈 없이 지나가지만 방심은 금물입니다.
...
※ 조언: "병은 키워서 고친다"는 말이 있습니다. 작은 증상도 무시하지 말고 조기에 관리하세요.`;
    ...
    return `【${animalName}띠 건강운 - 주의】

2026년 병오년 ${animalName}띠는 건강 관리에 특별한 주의가 필요한 해입니다. ${yearElement}의 기운이 충돌하여 체력 저하가 예상됩니다.
...
export function generateAnimalFortune(birthDate: string, dayMaster: string = '갑') {
  ...
  const yearHanja = `${yearGanji.stem}${yearGanji.branch}`;  // 예: 갑자

  return {
    summary: `${animal.emoji} ${fullZodiacName}\n${animal.personality}\n\n${fortune.overall}`,
    score: fortune.score,
    animalInfo: {
      name: fullZodiacName,  // 푸른쥐띠 형식으로 변경
      emoji: animal.emoji,
      element: `${stemToElement(yearGanji.stem) || '목'}`,  // 년간 오행 표시
      personality: animal.personality,
      yearHanja: yearHanja,  // 간지 정보
...
// 일간별 용신 색상 - 명리학 용신론 기반
const YONGSHIN_COLORS: Record<string, { color: string; element: string; reason: string }> = {
  '갑': { color: '초록색', element: '나무', reason: '갑목 일간에게 나무 기운이 자신을 돕는 색입니다.' },
  '을': { color: '연두색', element: '나무', reason: '을목 일간에게 부드러운 나무 기운이 어울립니다.' },
  '병': { color: '빨간색', element: '불', reason: '병화 일간에게 불 기운이 활력을 더합니다.' },
  '정': { color: '분홍색', element: '불', reason: '정화 일간에게 부드러운 불 기운이 어울립니다.' },
  '무': { color: '노란색', element: '흙', reason: '무토 일간에게 흙 기운이 안정을 줍니다.' },
  '기': { color: '갈색', element: '흙', reason: '기토 일간에게 부드러운 흙 기운이 어울립니다.' },
  '경': { color: '흰색', element: '금속', reason: '경금 일간에게 금속 기운이 결단력을 더합니다.' },
  '신': { color: '은색', element: '금속', reason: '신금 일간에게 부드러운 금속 기운이 어울립니다.' },
  '임': { color: '검은색', element: '물', reason: '임수 일간에게 물 기운이 지혜를 더합니다.' },
  '계': { color: '파란색', element: '물', reason: '계수 일간에게 부드러운 물 기운이 어울립니다.' },
};

// 일간별 행운의 방향 - 오행 방위론 기반
const YONGSHIN_DIRECTIONS: Record<string, { direction: string; reason: string }> = {
  '갑': { direction: '동쪽', reason: '나무 기운은 동쪽에서 옵니다.' },
  '을': { direction: '동쪽', reason: '나무 기운은 동쪽에서 옵니다.' },
  '병': { direction: '남쪽', reason: '불 기운은 남쪽에서 옵니다.' },
  '정': { direction: '남쪽', reason: '불 기운은 남쪽에서 옵니다.' },
  '무': { direction: '중앙', reason: '흙 기운은 중앙에서 옵니다.' },
  '기': { direction: '중앙', reason: '흙 기운은 중앙에서 옵니다.' },
  '경': { direction: '서쪽', reason: '금속 기운은 서쪽에서 옵니다.' },
  '신': { direction: '서쪽', reason: '금속 기운은 서쪽에서 옵니다.' },
  '임': { direction: '북쪽', reason: '물 기운은 북쪽에서 옵니다.' },
  '계': { direction: '북쪽', reason: '물 기운은 북쪽에서 옵니다.' },
};

// 일간별 행운의 물건 - 오행 상생 기반
const YONGSHIN_ITEMS: Record<string, { item: string; reason: string }> = {
  '갑': { item: '관엽식물, 나무 소품', reason: '나무 기운을 북돋아 주는 물건입니다.' },
  '을': { item: '꽃다발, 허브화분', reason: '부드러운 나무 기운을 더해주는 물건입니다.' },
  '병': { item: '조명, 양초', reason: '불 기운을 활성화하는 물건입니다.' },
  '정': { item: '향초, 따뜻한 음료', reason: '부드러운 불 기운을 더해주는 물건입니다.' },
  '무': { item: '도자기, 흙 화분', reason: '흙 기운을 안정시키는 물건입니다.' },
  '기': { item: '크리스탈, 천연석', reason: '부드러운 흙 기운을 더해주는 물건입니다.' },
  '경': { item: '금속 장신구, 시계', reason: '금속 기운을 강화하는 물건입니다.' },
  '신': { item: '은 액세서리, 동전', reason: '부드러운 금속 기운을 더해주는 물건입니다.' },
  '임': { item: '수정, 어항', reason: '물 기운을 활성화하는 물건입니다.' },
  '계': { item: '분수, 수반', reason: '부드러운 물 기운을 더해주는 물건입니다.' },
};

// 일간별 피해야 할 것들 - 오행 상극 기반 (기신)
const GISHIN_WARNINGS: Record<string, { color: string; direction: string; reason: string }> = {
  '갑': { color: '흰색/은색', direction: '서쪽', reason: '금속이 나무을 극합니다.' },
  '을': { color: '흰색/은색', direction: '서쪽', reason: '금속이 나무을 극합니다.' },
  '병': { color: '검은색/파란색', direction: '북쪽', reason: '물가 불를 극합니다.' },
  '정': { color: '검은색/파란색', direction: '북쪽', reason: '물가 불를 극합니다.' },
  '무': { color: '초록색', direction: '동쪽', reason: '나무이 흙를 극합니다.' },
  '기': { color: '초록색', direction: '동쪽', reason: '나무이 흙를 극합니다.' },
  '경': { color: '빨간색', direction: '남쪽', reason: '불가 금속을 극합니다.' },
  '신': { color: '빨간색', direction: '남쪽', reason: '불가 금속을 극합니다.' },
  '임': { color: '노란색/갈색', direction: '중앙', reason: '흙가 물를 극합니다.' },
  '계': { color: '노란색/갈색', direction: '중앙', reason: '흙가 물를 극합니다.' },
};
...
/**
 * 5신 체계 설명
 * - 용신: 사주에서 가장 필요한 오행, 사주의 균형을 맞추는 핵심
 * - 희신: 용신을 돕는 오행, 용신을 생하거나 도움
 * - 기신: 용신을 극하거나 방해하는 오행
 * - 구신: 기신을 돕는 오행, 기신을 생함
 * - 한신: 사주에 영향이 미미한 중립적 오행
 */
...
export function analyzeFiveSpirits(
  ...
  return {
    yongsin: {
      ...
      description: `${yongsinElement} 기운은 당신에게 가장 필요한 기운이에요. 이 기운이 강해지면 운이 좋아져요.`,
    },
    heesin: {
      element: heesinElement,
      hanja: ELEMENT_HANJA[heesinElement],
      description: `${heesinElement} 기운은 도움되는 기운을 돕는 역할을 해요. 함께하면 좋은 운을 만들어요.`,
    },
    gisin: {
      element: gisinElement,
      hanja: ELEMENT_HANJA[gisinElement],
      description: `${gisinElement} 기운은 도움되는 기운을 방해해요. 이 기운이 강해지면 주의가 필요해요.`,
    },
    gusin: {
      element: gusinElement,
      hanja: ELEMENT_HANJA[gusinElement],
      description: `${gusinElement} 기운은 주의할 기운을 돕는 역할이에요. 함께 안 좋은 영향을 줄 수 있어요.`,
    },
    hansin: {
      element: hansinElement,
      hanja: ELEMENT_HANJA[hansinElement],
      description: `${hansinElement} 기운은 영향이 크지 않은 중립적인 기운이에요.`,
    },
    summary: isStrong
      ? `타고난 기운이 강한 편이라, ${yongsinElement} 기운으로 균형을 맞추면 좋아요.`
      : `타고난 기운이 약한 편이라, ${yongsinElement} 기운이 힘을 보태줘요.`,
    advice: isStrong
      ? `${yongsinElement} 색상(${getElementColor(yongsinElement)})의 물건이나 ${getElementDirection(yongsinElement)} 방향이 좋아요.`
      : `${yongsinElement} 색상(${getElementColor(yongsinElement)})의 물건이나 ${getElementDirection(yongsinElement)} 방향이 좋아요.`,
  };
}
...
const COMPATIBLE_ANIMALS: Record<string, { good: string[]; reason: string }> = {
  '갑': { good: ['호랑이띠', '토끼띠', '용띠'], reason: '나무 기운과 삼합/육합하는 띠입니다.' },
  '을': { good: ['호랑이띠', '토끼띠', '양띠'], reason: '나무 기운과 조화로운 띠입니다.' },
  '병': { good: ['뱀띠', '말띠', '양띠'], reason: '불 기운과 삼합하는 띠입니다.' },
  '정': { good: ['뱀띠', '말띠', '개띠'], reason: '불 기운과 조화로운 띠입니다.' },
  '무': { good: ['소띠', '용띠', '원숭이띠'], reason: '흙 기운과 삼합하는 띠입니다.' },
  '기': { good: ['소띠', '닭띠', '돼지띠'], reason: '흙 기운과 조화로운 띠입니다.' },
  '경': { good: ['원숭이띠', '닭띠', '뱀띠'], reason: '금속 기운과 삼합하는 띠입니다.' },
  '신': { good: ['원숭이띠', '닭띠', '용띠'], reason: '금속 기운과 조화로운 띠입니다.' },
  '임': { good: ['쥐띠', '돼지띠', '용띠'], reason: '물 기운과 삼합하는 띠입니다.' },
  '계': { good: ['쥐띠', '돼지띠', '소띠'], reason: '물 기운과 조화로운 띠입니다.' },
};

// 십이시진 - 하루의 길운 시간대
const LUCKY_TIME_SLOTS = [
  { name: '자시', time: '밤 11시~새벽 1시', element: '물', suitable: ['임', '계', '갑', '을'] },
  { name: '축시', time: '새벽 1시~3시', element: '흙', suitable: ['무', '기', '경', '신'] },
  { name: '인시', time: '새벽 3시~5시', element: '나무', suitable: ['갑', '을', '병', '정'] },
  { name: '묘시', time: '새벽 5시~7시', element: '나무', suitable: ['갑', '을', '병', '정'] },
  { name: '진시', time: '오전 7시~9시', element: '흙', suitable: ['무', '기', '경', '신'] },
  { name: '사시', time: '오전 9시~11시', element: '불', suitable: ['병', '정', '무', '기'] },
  { name: '오시', time: '오전 11시~오후 1시', element: '불', suitable: ['병', '정', '무', '기'] },
  { name: '미시', time: '오후 1시~3시', element: '흙', suitable: ['무', '기', '경', '신'] },
  { name: '신시', time: '오후 3시~5시', element: '금속', suitable: ['경', '신', '임', '계'] },
  { name: '유시', time: '오후 5시~7시', element: '금속', suitable: ['경', '신', '임', '계'] },
  { name: '술시', time: '저녁 7시~9시', element: '흙', suitable: ['무', '기', '경', '신'] },
  { name: '해시', time: '밤 9시~11시', element: '물', suitable: ['임', '계', '갑', '을'] },
];
...
export function generateLuckyInfo(birthDate: string, dayMaster?: string, targetDate: Date = new Date()) {
  ...
  const elementAdvice: Record<string, string> = {
    '나무': '나무의 기운처럼 성장과 발전에 좋은 날입니다. 새로운 시작이나 계획에 적합합니다.',
    '불': '불의 기운처럼 활력과 열정이 넘치는 날입니다. 적극적인 활동에 좋습니다.',
    '흙': '흙의 기운처럼 안정과 신뢰가 중요한 날입니다. 중재나 조정에 적합합니다.',
    '금속': '쇠의 기운처럼 결단과 실행이 중요한 날입니다. 마무리나 정리에 좋습니다.',
    '물': '물의 기운처럼 지혜와 유연함이 중요한 날입니다. 학습이나 연구에 적합합니다.',
  };
  ...
  return {
    ...
    categories: [
      ...
      },
      {
        emoji: '🔢',
        title: '행운의 숫자',
        content: `${luckyNumbers}\n\n${colorInfo.element}의 오행에 해당하는 하도낙서 기반 숫자입니다.`,
        score: 75 + (combinedHash % 15),
      },
      {
        emoji: '🧭',
    ...
    advice: elementAdvice[colorInfo.element] || elementAdvice['흙'],
  };
}
...
export function generateComprehensiveFortune(
  ...
  // 오행 분석 텍스트 생성
  const elementAnalysisText = `도움 기운: ${fiveSpirits.yongsin.element}, 보조 기운: ${fiveSpirits.heesin.element}`;
  ...
  // 시간대별 조언 생성 (날짜에 따라 다르게, 오행별로 특화)
  // 오행별 아침 조언 (각 15개씩 = 총 75개)
  const morningAdvicesByElement: Record<string, string[]> = {
    wood: [
      `나무의 기운으로 새벽의 신선한 공기를 들이마시세요. 창문을 열고 환기하면 하루가 상쾌해집니다.`,
      `나무의 성장 에너지가 아침에 가장 강합니다. 새로운 계획을 세우기 좋은 시간이에요.`,
      `푸른 식물 가까이에서 아침을 시작하면 활력이 충전됩니다. 관엽식물에 물을 주는 것도 좋아요.`,
      `아침 스트레칭으로 뻣뻣한 몸을 깨우세요. 나무처럼 유연하게 하루를 맞이하세요.`,
      `초록색 음식(샐러드, 채소)으로 아침을 시작하면 건강운이 좋아집니다.`,
      `일찍 일어나 목표 리스트를 작성하세요. 나무가 햇빛을 향해 자라듯 방향을 정하세요.`,
      `오전 9시 전에 중요한 전화나 연락을 하면 좋은 반응을 얻을 수 있어요.`,
      `출근길에 초록색 옷이나 소품을 활용하면 에너지가 상승합니다.`,
      `아침에 산책하며 나무를 바라보세요. 자연의 기운이 당신에게 전해집니다.`,
      `오전에 팀원들과 브리핑을 하면 좋은 아이디어가 나옵니다. 협력의 시간이에요.`,
      `아침 명상 5분으로 마음을 고요하게 하세요. 성장을 위한 뿌리를 내리는 시간입니다.`,
      `신선한 과일 주스로 활력을 충전하세요. 나무의 기운이 당신을 깨워줍니다.`,
      `오전에 학습이나 독서를 시작하면 집중력이 높습니다. 지식의 씨앗을 심으세요.`,
      `가볍게 요가를 하며 몸을 깨우세요. 유연함이 오늘의 키워드입니다.`,
      `아침 햇살을 5분간 쬐면 비타민D와 함께 좋은 기운이 충전됩니다.`,
    ],
    fire: [
      `열정적으로 하루를 시작하세요! 빨간색 머그컵으로 커피를 마시면 활력이 넘칩니다.`,
      `아침에 좋아하는 음악을 틀어놓고 움직이세요. 불의 에너지가 깨어납니다.`,
      `거울을 보며 자신에게 긍정적인 말을 해주세요. "오늘도 빛나는 하루가 될 거야!"`,
      `뜨거운 차나 따뜻한 물로 아침을 시작하면 몸과 마음이 활성화됩니다.`,
      `오전에 창의적인 작업을 하면 아이디어가 불꽃처럼 터집니다. 표현하세요!`,
      `밝은 조명 아래서 아침 준비를 하세요. 빛의 기운이 운기를 높여줍니다.`,
      `아침에 화려한 색상의 옷을 입으면 자신감이 상승합니다. 주목받는 하루가 될 거예요.`,
      `출근 전 짧은 댄스나 운동으로 심장을 뛰게 하세요. 에너지가 솟구칩니다.`,
      `아침에 SNS에 긍정적인 글을 올려보세요. 좋은 반응이 돌아올 수 있어요.`,
      `중요한 발표나 미팅이 있다면 오전에 잡으세요. 표현력이 정점에 달합니다.`,
      `매운 음식이나 생강차로 아침을 깨우면 집중력이 높아집니다.`,
      `아침에 좋아하는 사람에게 따뜻한 인사를 건네세요. 사랑의 기운이 돌아옵니다.`,
      `일출을 보며 명상하면 영감이 떠오릅니다. 새로운 시작의 에너지를 받으세요.`,
      `오전 회의에서 적극적으로 의견을 내세요. 당신의 아이디어가 빛날 때입니다.`,
      `아침에 감사 일기를 쓰면 하루 종일 긍정적인 기운이 따라옵니다.`,
    ],
    earth: [
      `안정적으로 하루를 시작하세요. 규칙적인 아침 루틴이 운기를 높여줍니다.`,
      `든든한 아침 식사로 에너지를 채우세요. 밥과 된장국 같은 따뜻한 한식이 좋아요.`,
      `아침에 정리정돈을 하면 마음도 정리됩니다. 책상을 깔끔하게 만드세요.`,
      `황토색이나 베이지톤 옷을 입으면 안정감이 높아집니다.`,
      `오전에 재정 상태를 점검하거나 가계부를 정리하면 재물운이 상승합니다.`,
      `아침에 가족과 함께 식사하면 좋은 기운이 흐릅니다. 대화를 나누세요.`,
      `출근 전 집안의 식물에 물을 주거나 화분 정리를 하면 운기가 좋아져요.`,
      `오전에 현실적인 계획을 세우세요. 실천 가능한 목표가 성공의 열쇠입니다.`,
      `아침에 흙을 밟거나 정원을 거닐면 흙의 기운이 충전됩니다.`,
      `중요한 계약이나 거래는 오전에 진행하면 안정적으로 마무리됩니다.`,
      `아침에 따뜻한 죽이나 오트밀로 속을 달래면 건강운이 상승합니다.`,
      `오전 일찍 부동산이나 재테크 관련 정보를 확인하면 좋은 기회를 발견할 수 있어요.`,
      `아침에 감사한 마음으로 기도나 명상을 하면 마음이 평온해집니다.`,
      `출근길에 지하철보다 버스를 타면 땅의 기운을 더 받을 수 있어요.`,
      `아침에 믿음직한 동료와 대화하면 좋은 조언을 얻을 수 있습니다.`,
    ],
    metal: [
      `맑은 정신으로 하루를 시작하세요. 찬물로 세수하면 집중력이 높아집니다.`,
      `아침에 중요한 결정을 내리면 명확한 판단이 가능합니다. 단호하게 선택하세요.`,
      `흰색이나 은색 옷을 입으면 카리스마가 생깁니다. 리더십을 발휘할 날이에요.`,
      `오전에 정밀한 작업이나 숫자 관련 일을 처리하면 실수가 적습니다.`,
      `아침에 시계나 액세서리를 정리하면 금속의 기운이 정돈됩니다.`,
      `맑은 공기를 깊이 들이마시며 심호흡하세요. 머리가 맑아집니다.`,
      `아침에 간단한 악기 연주나 음악 감상은 정서적 안정을 줍니다.`,
      `출근 전 오늘의 우선순위를 정하세요. 효율적인 하루가 됩니다.`,
      `오전에 법적인 문서나 계약서를 검토하면 꼼꼼하게 확인할 수 있어요.`,
      `아침에 은행 업무나 금융 관련 일을 처리하면 순조롭습니다.`,
      `깨끗하게 정돈된 공간에서 아침을 시작하면 집중력이 올라갑니다.`,
      `아침에 어려운 대화나 피드백을 하면 상대방이 더 잘 수용합니다.`,
      `오전에 운동할 때는 근력 운동이 효과적입니다. 강하게 밀어붙이세요.`,
      `아침에 금속 소재의 펜이나 시계를 착용하면 결단력이 생깁니다.`,
      `차갑지만 명쾌한 마음으로 일을 시작하세요. 오늘은 효율의 날입니다.`,
    ],
    water: [
      `물 한 잔으로 하루를 시작하세요. 물의 기운이 몸을 정화합니다.`,
      `아침에 차분하게 명상하면 직관력이 높아집니다. 조용히 마음의 소리를 들으세요.`,
      `검은색이나 파란색 옷을 입으면 지혜로운 기운이 감돕니다.`,
      `오전에 학습이나 연구를 하면 집중력이 최고조에 달합니다.`,
      `아침에 일기를 쓰거나 생각을 정리하면 통찰력이 생깁니다.`,
      `샤워하며 하루를 계획하세요. 물의 흐름처럼 유연하게 대응할 수 있어요.`,
      `아침에 차나 허브티를 마시며 여유를 가지면 하루가 순조롭습니다.`,
      `오전에 조용한 곳에서 독서하면 지혜의 씨앗이 심어집니다.`,
      `아침에 물가 근처를 산책하면 영감이 떠오릅니다. 분수대나 강변이 좋아요.`,
      `출근 전 뉴스나 정보를 확인하면 대화에서 유리해집니다.`,
      `아침에 멘토나 선배에게 연락하면 좋은 조언을 얻을 수 있어요.`,
      `오전에 명상 앱을 활용해 5분간 고요한 시간을 가지세요.`,
      `아침에 수영이나 물과 관련된 운동을 하면 건강운이 상승합니다.`,
      `차분한 마음으로 이메일을 확인하고 답장하세요. 실수가 줄어듭니다.`,
      `아침에 꿈을 기록하면 무의식의 메시지를 발견할 수 있어요.`,
    ],
  };

  // 오행별 오후 조언 (각 15개씩 = 총 75개)
  const afternoonAdvicesByElement: Record<string, string[]> = {
    wood: [
      `점심 후 가볍게 걷기 운동을 하세요. 나무처럼 굳건하게 서있는 자세가 도움됩니다.`,
      `오후에 새로운 프로젝트를 시작하면 성장의 에너지가 함께합니다.`,
      `동료들과 협력하는 업무가 잘 풀립니다. 팀워크를 발휘하세요.`,
      `오후 3시경 녹차나 말차를 마시면 집중력이 회복됩니다.`,
      `창가 자리에서 일하면 나무의 기운과 햇빛을 함께 받을 수 있어요.`,
      `오후에 네트워킹이나 인맥 관리에 시간을 투자하면 좋은 결과가 있습니다.`,
      `점심 후 짧은 낮잠보다 가벼운 산책이 더 효과적입니다.`,
      `오후에 온라인 강의나 웨비나에 참석하면 새로운 지식을 얻습니다.`,
      `식물이 있는 카페에서 잠시 쉬면 재충전이 됩니다.`,
      `오후에 창의적인 브레인스토밍을 하면 아이디어가 풍부해집니다.`,
      `점심에 채식 위주의 식사를 하면 오후가 가볍고 상쾌합니다.`,
      `오후에 형제나 친구에게 연락하면 좋은 소식이 있을 수 있어요.`,
      `업무 중간에 스트레칭으로 굳은 어깨를 풀어주세요.`,
      `오후 미팅에서는 경청하는 자세가 중요합니다. 상대의 말을 잘 들으세요.`,
      `일과 후 요가나 필라테스 수업을 예약해두면 기대감이 생깁니다.`,
    ],
    fire: [
      `오후에 에너지가 최고조에 달합니다. 중요한 발표나 협상은 이 시간에!`,
      `점심 후 동료들과 활발한 대화를 나누면 좋은 아이디어가 나옵니다.`,
      `오후 2시~4시 사이가 창의력이 폭발하는 시간입니다. 창작 활동에 집중하세요.`,
      `뜨거운 에스프레소 한 잔이 오후의 집중력을 높여줍니다.`,
      `오후에 SNS 활동이나 블로그 글쓰기가 잘 됩니다. 표현하세요!`,
      `프레젠테이션이나 연설이 있다면 오후에 최고의 퍼포먼스를 낼 수 있어요.`,
      `오후에 미술관이나 전시회 방문은 영감을 줍니다.`,
      `활발한 토론이나 회의에서 당신의 의견이 빛납니다.`,
      `점심 후 음악을 들으며 일하면 창의력이 상승합니다.`,
      `오후에 고객을 만나거나 영업 활동을 하면 좋은 성과가 있어요.`,
      `밝은 조명 아래서 일하면 집중력이 유지됩니다.`,
      `오후 티타임에 동료와 아이디어를 공유하면 시너지가 납니다.`,
      `오후에 취미 활동이나 동호회 모임에 참석하면 즐거운 시간이 됩니다.`,
      `열정적으로 일하되, 잠깐 휴식을 취해 불꽃이 꺼지지 않게 하세요.`,
      `오후에 새로운 취미를 시작하면 지속될 가능성이 높아요.`,
    ],
    earth: [
      `점심에 든든하게 먹고 안정적으로 오후를 보내세요.`,
      `오후에 재정 관련 업무를 처리하면 순조롭습니다.`,
      `믿을 수 있는 동료와 함께하는 업무가 좋은 결과를 냅니다.`,
      `오후에 부동산이나 투자 상담을 받으면 좋은 정보를 얻어요.`,
      `점심 후 잠깐 명상하며 마음을 안정시키면 오후가 순조롭습니다.`,
      `오후에 어머니나 가족에게 연락하면 따뜻한 대화가 오갑니다.`,
      `현실적인 목표를 재점검하고 실행 계획을 세우세요.`,
      `오후에 중요한 서류 작업이나 행정 업무가 잘 진행됩니다.`,
      `신뢰할 수 있는 브랜드나 검증된 제품을 구매하기 좋은 시간입니다.`,
      `오후에 건강검진이나 의료 상담을 받으면 좋아요.`,
      `점심 약속은 조용하고 안정적인 분위기의 식당이 좋습니다.`,
      `오후에 저축이나 보험 관련 검토를 하면 좋은 선택을 할 수 있어요.`,
      `땅을 밟는 느낌으로 안정감 있게 업무를 진행하세요.`,
      `오후에 후배를 지도하거나 멘토링하면 보람을 느낍니다.`,
      `신중하게 결정하되, 너무 오래 고민하지는 마세요.`,
    ],
    metal: [
      `오후에 정밀한 작업이나 분석 업무가 잘 됩니다.`,
      `점심 후 중요한 결정을 내리면 명확한 판단이 가능해요.`,
      `오후에 법적인 문제나 계약 관련 일을 처리하면 좋습니다.`,
      `효율적으로 시간을 관리하며 업무를 처리하세요.`,
      `오후에 정리정돈이나 파일 관리를 하면 마음이 맑아집니다.`,
      `회의에서 핵심만 간결하게 말하면 설득력이 높아집니다.`,
      `오후에 전문가 상담이나 코칭을 받으면 효과적이에요.`,
      `금속 액세서리를 착용하면 결단력이 생깁니다.`,
      `오후에 의료 검진이나 치과 방문이 순조롭습니다.`,
      `정확한 데이터와 팩트로 업무를 처리하면 인정받습니다.`,
      `오후에 불필요한 물건을 정리하거나 버리면 기분이 상쾌해져요.`,
      `명확한 기준으로 우선순위를 정하고 일하세요.`,
      `오후에 기술적인 문제 해결이나 트러블슈팅이 잘 됩니다.`,
      `차분하게 피드백을 주고받으면 관계가 개선됩니다.`,
      `오후에 정확한 약속 시간을 지키면 신뢰가 쌓입니다.`,
    ],
    water: [
      `오후에 조용히 연구하거나 분석하는 시간을 가지세요.`,
      `점심 후 차분하게 이메일이나 문서를 검토하면 좋습니다.`,
      `오후에 멘토나 선배와 대화하면 귀한 조언을 얻어요.`,
      `물을 자주 마시며 수분을 보충하면 집중력이 유지됩니다.`,
      `오후에 복잡한 문제를 깊이 생각해보면 해결책이 떠오릅니다.`,
      `조용한 카페나 도서관에서 일하면 효율이 높아요.`,
      `오후에 온라인 강의를 들으면 집중력이 좋습니다.`,
      `유연하게 상황에 대처하면 예상치 못한 일도 잘 풀립니다.`,
      `오후에 심리 상담이나 코칭을 받으면 통찰력이 생겨요.`,
      `물가 근처 식당에서 점심을 먹으면 기분 전환이 됩니다.`,
      `오후에 명상 앱으로 5분간 마음을 가라앉히세요.`,
      `직관을 믿고 결정하면 좋은 결과가 있을 수 있어요.`,
      `오후에 외국어 공부나 자격증 준비가 잘 됩니다.`,
      `차분한 마음으로 상대의 말을 경청하면 숨은 의도를 파악할 수 있어요.`,
      `오후에 수족관이나 물 관련 취미를 즐기면 스트레스가 풀려요.`,
    ],
  };

  // 오행별 저녁 조언 (각 15개씩 = 총 75개)
  const eveningAdvicesByElement: Record<string, string[]> = {
    wood: [
      `저녁에 숲속 산책 영상을 보며 휴식하세요. 자연의 기운이 전해집니다.`,
      `저녁 식사 후 간단한 스트레칭으로 하루의 긴장을 풀어주세요.`,
      `가족이나 친구와 대화하며 관계의 나무를 키우세요.`,
      `저녁에 내일 할 일을 정리하면 성장의 방향이 명확해집니다.`,
      `녹색 조명이나 관엽식물 근처에서 독서하면 마음이 편안해져요.`,
      `저녁에 요가나 필라테스로 유연성을 기르면 좋습니다.`,
      `취침 전 허브차를 마시면 숙면에 도움이 됩니다.`,
      `저녁에 일기를 쓰며 하루를 정리하세요. 성장의 기록이 됩니다.`,
      `가볍게 정원을 가꾸거나 베란다 식물을 돌보면 힐링이 됩니다.`,
      `저녁 산책으로 맑은 공기를 마시면 컨디션이 좋아져요.`,
      `저녁에 형제나 오래된 친구에게 연락하면 따뜻한 대화가 오갑니다.`,
      `취침 전 명상으로 나무처럼 뿌리를 내리는 상상을 하세요.`,
      `저녁에 새로운 기술이나 취미를 배우면 즐거움을 느낍니다.`,
      `편안한 녹색 계열의 잠옷이나 이불이 숙면을 도와줍니다.`,
      `저녁에 내일의 목표를 마음속에 그려보면 실현 가능성이 높아져요.`,
    ],
    fire: [
      `저녁에 촛불을 켜고 명상하면 마음이 따뜻해집니다.`,
      `가족과 함께 따뜻한 저녁 식사를 하면 사랑의 기운이 충전돼요.`,
      `저녁에 좋아하는 영화나 드라마를 보며 감정을 해소하세요.`,
      `취침 전 따뜻한 물로 족욕을 하면 숙면에 좋습니다.`,
      `저녁에 사랑하는 사람에게 따뜻한 말을 건네세요.`,
      `저녁 산책 시 노을을 바라보면 영감이 떠오릅니다.`,
      `취침 전 감사한 일을 떠올리면 긍정적인 에너지가 쌓여요.`,
      `저녁에 따뜻한 차를 마시며 하루를 정리하세요.`,
      `친구들과 즐거운 저녁 모임을 가지면 스트레스가 풀립니다.`,
      `저녁에 창작 활동(그림, 글쓰기)을 하면 표현욕이 해소돼요.`,
      `취침 전 좋아하는 음악을 들으며 마음을 가라앉히세요.`,
      `저녁에 요리를 직접 하면 불의 기운과 함께 만족감이 생겨요.`,
      `사랑하는 사람과 따뜻한 대화를 나누면 행복해집니다.`,
      `저녁에 작은 선물이나 감사 편지를 쓰면 관계가 좋아져요.`,
      `취침 전 내일의 즐거운 일을 상상하며 잠들면 좋은 꿈을 꿔요.`,
    ],
    earth: [
      `저녁에 가족과 함께 식사하면 안정감이 생깁니다.`,
      `취침 전 집안을 정리정돈하면 마음도 편안해져요.`,
      `저녁에 내일 준비물을 미리 챙기면 아침이 여유로워집니다.`,
      `따뜻한 국물 요리로 저녁을 먹으면 속이 편안해져요.`,
      `저녁에 재정 계획을 검토하면 안정적인 미래를 그릴 수 있어요.`,
      `취침 전 가계부를 정리하면 재물운이 좋아집니다.`,
      `저녁에 부모님께 안부 전화를 하면 따뜻한 기운이 흐릅니다.`,
      `편안한 집에서 휴식하며 에너지를 충전하세요.`,
      `저녁에 오래된 사진을 보며 추억에 잠기면 마음이 따뜻해져요.`,
      `취침 전 내일 입을 옷을 미리 준비하면 아침이 편해집니다.`,
      `저녁에 조용히 책을 읽으며 마음을 안정시키세요.`,
      `가족과 함께 보드게임이나 카드게임을 하면 유대감이 깊어져요.`,
      `저녁에 따뜻한 물로 샤워하면 하루의 피로가 풀립니다.`,
      `취침 전 감사 일기를 쓰면 안정적인 마음으로 잠들 수 있어요.`,
      `저녁에 내일의 식단을 계획하면 건강한 하루가 됩니다.`,
    ],
    metal: [
      `저녁에 하루를 정리하며 성과를 점검하세요.`,
      `취침 전 내일의 우선순위를 정해두면 효율적인 아침이 됩니다.`,
      `저녁에 조용한 음악을 들으며 마음을 정돈하세요.`,
      `깨끗하게 샤워하고 정돈된 침실에서 잠들면 숙면에 좋아요.`,
      `저녁에 불필요한 앱이나 파일을 정리하면 마음이 가벼워져요.`,
      `취침 전 짧은 독서로 지식을 쌓으면 만족감이 생깁니다.`,
      `저녁에 피부 관리나 셀프 케어를 하면 다음날 컨디션이 좋아요.`,
      `명확한 시간에 잠들고 일어나는 규칙적인 수면이 중요합니다.`,
      `저녁에 내일 회의나 미팅 자료를 준비하면 안심이 됩니다.`,
      `취침 전 가볍게 스트레칭하며 근육의 긴장을 풀어주세요.`,
      `저녁에 액세서리나 귀중품을 정리정돈하면 기분이 좋아져요.`,
      `조용한 환경에서 명상하며 하루를 마무리하세요.`,
      `저녁에 중요한 결정은 피하고, 내일 맑은 머리로 판단하세요.`,
      `취침 전 화이트 노이즈나 자연 소리를 들으면 숙면에 도움이 돼요.`,
      `저녁에 내일 입을 깔끔한 옷을 준비해두면 자신감이 생겨요.`,
    ],
    water: [
      `저녁에 따뜻한 물로 반신욕을 하면 피로가 풀리고 잠이 잘 와요.`,
      `취침 전 차분하게 명상하며 하루를 돌아보세요.`,
      `저녁에 일기를 쓰며 생각을 정리하면 마음이 맑아집니다.`,
      `가족이나 친구와 깊은 대화를 나누면 위로가 됩니다.`,
      `저녁에 물 한 잔을 마시며 하루를 마무리하세요.`,
      `취침 전 좋아하는 책을 읽으면 지혜가 쌓입니다.`,
      `저녁에 수족관의 물고기를 바라보면 마음이 평온해져요.`,
      `조용한 음악과 함께 휴식하면 스트레스가 해소됩니다.`,
      `저녁에 내일 배울 것이나 공부할 내용을 정해두면 좋아요.`,
      `취침 전 감사한 일을 떠올리며 긍정적인 마음으로 잠드세요.`,
      `저녁에 영화나 다큐멘터리를 보며 새로운 지식을 얻으세요.`,
      `따뜻한 허브차(캐모마일, 라벤더)가 숙면을 도와줍니다.`,
      `저녁에 수영장이나 온천을 방문하면 힐링이 됩니다.`,
      `취침 전 내일의 꿈을 마음속에 그려보며 잠드세요.`,
      `저녁에 비 오는 소리나 파도 소리 ASMR을 들으면 편안해져요.`,
    ],
  };

  // 일간 오행에 맞는 조언 배열 선택
  const morningAdvices = morningAdvicesByElement[dayMasterElement] || morningAdvicesByElement.earth;
  const afternoonAdvices = afternoonAdvicesByElement[dayMasterElement] || afternoonAdvicesByElement.earth;
  const eveningAdvices = eveningAdvicesByElement[dayMasterElement] || eveningAdvicesByElement.earth;
  ...
  return {
    ...
    tojeongFortune: {
      ...
      score: tojeong.score,
      luckyLevel: tojeong.score >= 85 ? '매우 좋은 운' : tojeong.score >= 70 ? '좋은 운' : tojeong.score >= 55 ? '평' : '흉',
    },
