...
const ELEMENT_RELATION_DETAILS: Record<string, {
  ...
  generate: {
    name: '내 에너지를 쏟아내는 관계',
    description: '당신의 기운이 오늘의 기운을 키워주는 관계예요.',
    effect: '에너지가 빠져나갈 수 있지만, 그만큼 보람과 성취감을 느끼게 돼요. 다른 사람을 돕거나 창작 활동에 좋은 날이에요.',
    advice: '무리하지 않는 선에서 능동적으로 행동하세요. 체력 관리에 신경 쓰세요.',
    detailedMeaning: '오늘은 당신 안의 에너지가 자연스럽게 밖으로 흘러나가는 날이에요. 마치 나무가 꽃을 피우고 열매를 맺듯, 당신의 재능과 노력이 결실을 맺는 방향으로 에너지가 흐르고 있어요. 창작 활동, 발표, 가르치는 일에서 빛을 발하는 날이에요. 다만 에너지를 주는 쪽이라 체력 소모가 있을 수 있으니, 무리하지 않는 것이 중요해요.',
    energyFlow: '내 안의 에너지가 밖으로 발산돼요. 창조하고 표현하고 나누는 기운이에요. 다만 체력 소모가 있을 수 있으니 쉬어가며 하세요.',
    practicalGuidance: [
  ...
  generated: {
    name: '힘을 받는 관계',
    description: '오늘의 기운이 당신에게 힘을 불어넣어주는 관계예요.',
    effect: '주변으로부터 도움이나 좋은 기회가 찾아와요. 새로운 것을 배우기에 좋은 날이에요.',
    advice: '열린 마음으로 주변의 호의를 받아들이세요. 감사하는 마음이 더 큰 복을 부른답니다.',
    detailedMeaning: '오늘은 주변에서 당신을 보호하고 성장시켜주는 따뜻한 기운이 흐르는 날이에요. 마치 봄비가 내려 새싹이 자라듯, 필요한 도움이 적재적소에 나타나고 지혜가 열리는 시간이에요. 무언가를 배우거나 조언을 구하기에 최적의 날이에요.',
    energyFlow: '밖에서 안으로 좋은 에너지가 들어와요. 배우고 성장하는 기운이에요. 충전되는 느낌을 받을 수 있어요.',
    practicalGuidance: [
  ...
  control: {
    name: '주도하는 관계',
    description: '당신이 상황을 이끌고 통제할 수 있는 관계예요.',
    effect: '주도적으로 움직일 수 있어요. 다만 너무 세게 밀어붙이면 역효과가 날 수 있으니 균형이 필요해요.',
    advice: '자신감을 갖되 상대방 입장도 배려하세요. 협상이나 결단에 좋은 날이에요.',
    detailedMeaning: '오늘은 당신이 상황의 주도권을 쥘 수 있는 날이에요. 원하는 것을 향해 적극적으로 움직이면 좋은 결과가 따라요. 마치 사냥꾼이 먹이를 향해 정확히 활시위를 당기듯, 목표를 향한 추진력이 강해지고 결단력이 생겨요. 다만 욕심이 과하면 오히려 잃을 수 있으니 적당한 선에서 만족하세요.',
    energyFlow: '적극적으로 움직이는 에너지예요. 목표를 향해 나아가고 성취하는 기운이에요. 다만 에너지 소모도 따라요.',
    practicalGuidance: [
  ...
  controlled: {
    name: '압박을 받는 관계',
    description: '오늘의 기운이 당신을 눌러오는 관계예요.',
    effect: '외부의 압박이나 장애물을 만날 수 있어요. 신중하게 행동하고, 무리한 도전은 피하세요.',
    advice: '오늘은 방어적으로 임하세요. 새로운 일보다는 기존 일을 정리하는 데 집중하세요.',
    detailedMeaning: '오늘은 밖에서 나를 누르는 힘이 작용하는 날이에요. 상사의 지시, 예상 못한 책임, 외부의 간섭 등이 생길 수 있어요. 하지만 이런 압박을 잘 견디면 오히려 성장의 기회가 돼요. 마치 다이아몬드가 강한 압력 속에서 만들어지듯, 오늘의 어려움이 당신을 더 단단하게 만들어줄 거예요. 다만 너무 무리하면 스트레스가 쌓이니, 할 수 있는 만큼만 하세요.',
    energyFlow: '밖에서 안으로 압력이 오는 에너지예요. 잘 받아들이면 성장하고, 무리하게 저항하면 지쳐요.',
    practicalGuidance: [
  ...
  same: {
    name: '나와 같은 기운',
    description: '오늘의 기운이 당신과 같은 성질이에요.',
    effect: '장점이 배가되지만 단점도 부각될 수 있어요. 비슷한 사람과 잘 맞지만 경쟁이 생길 수도 있어요.',
    advice: '강점을 살리되, 지나친 고집은 피하세요. 경쟁보다 협력이 더 좋은 결과를 가져와요.',
    detailedMeaning: '오늘은 나와 비슷한 에너지가 겹치는 날이에요. 마치 같은 색의 물감을 섞으면 색이 진해지듯, 당신의 성향이 더욱 강해져요. 장점은 더 빛나지만 단점도 함께 커질 수 있어요. 비슷한 생각을 가진 사람들과 잘 통하지만, 같은 것을 원하는 사람끼리 부딪힐 수도 있으니 양보하는 마음이 필요해요.',
    energyFlow: '같은 기운이 겹쳐서 강해져요. 나다운 모습이 극대화되지만, 경쟁도 생길 수 있어요.',
    practicalGuidance: [
      '자신만의 색깔과 장점을 살리세요',
...
const BRANCH_RELATION_DETAILS: Record<string, {
  ...
  '육합': {
    name: '찰떡궁합의 날',
    description: '서로 끌어당기는 좋은 기운이 흘러요.',
    effect: '인연이 맺어지기 좋고, 협력과 화합이 잘 이루어지는 날이에요. 대인관계에서 좋은 일이 생길 수 있어요.',
    simpleExplanation: '오늘은 "찰떡궁합"인 날이에요! 사람들과 잘 맞고, 협력하면 좋은 결과가 나오는 날이에요.',
    detailedMeaning: '오늘은 기운이 서로 딱 맞아떨어지는 아주 좋은 날이에요. 마치 자석의 N극과 S극이 서로 끌어당기듯, 사람들 사이에 강한 유대감이 형성돼요. 새로운 인연을 만나기에도, 기존 관계를 더 깊게 하기에도 최고의 날이에요. 계약이나 파트너십에도 매우 유리해요.',
    energyType: '서로 다른 것이 만나 하나가 되는 조화의 에너지예요. 인간관계에서 강한 유대감이 생겨요.',
    practicalGuidance: [
  ...
  '삼합': {
    name: '팀워크가 빛나는 날',
    description: '여러 기운이 모여 강한 힘을 만들어요.',
    effect: '큰 일을 도모하거나 팀워크가 필요한 일에 딱 좋아요. 함께 하면 시너지가 나요.',
    simpleExplanation: '오늘은 "팀플 대박"인 날이에요! 혼자보다 여러 사람과 함께하면 큰 힘이 나는 날이에요.',
    detailedMeaning: '오늘은 여러 기운이 한데 모여 강력한 에너지를 만들어내는 날이에요. 혼자서는 어려운 일도 여럿이 함께하면 거뜬히 해낼 수 있어요. 사업 확장, 팀 프로젝트, 큰 행사를 추진하기에 최적의 날이에요.',
  ...
  '육충': {
    name: '부딪히기 쉬운 날',
    description: '정반대의 기운이 충돌하는 관계예요.',
    effect: '갈등이나 장애물을 만날 수 있어요. 중요한 결정은 미루고, 감정적 대응은 피하세요.',
    simpleExplanation: '오늘은 "부딪히기 쉬운" 날이에요. 정반대 에너지가 만나서 갈등이 생기기 쉽지만, 한 발 물러서면 괜찮아요.',
    detailedMeaning: '오늘은 서로 반대되는 기운이 정면으로 부딪히는 날이에요. 갈등, 변화, 예상 못한 이동 등이 생길 수 있어요. 하지만 꼭 나쁜 것만은 아니에요 — 때로는 정체된 상황을 깨고 새로운 변화를 만드는 계기가 되기도 해요. 오늘은 유연하게 대처하는 것이 핵심이에요.',
  ...
  '육해': {
    name: '은근히 손해보는 날',
    description: '눈에 보이지 않는 곳에서 방해가 생겨요.',
    effect: '겉으로 드러나지 않는 문제가 생길 수 있어요. 세부 사항을 꼼꼼히 확인하세요.',
    simpleExplanation: '오늘은 "은근히 손해보는" 날이에요. 눈에 잘 안 보이는 곳에서 문제가 생길 수 있으니 꼼꼼히 체크하세요.',
    detailedMeaning: '오늘은 겉으로는 괜찮아 보이지만 안 보이는 곳에서 문제가 생기기 쉬운 날이에요. 믿었던 사람이 실망을 줄 수도 있고, 작은 실수가 나중에 큰 문제로 번질 수도 있어요. 계약서는 꼼꼼히 읽고, 뒷면까지 확인하세요.',
  ...
  '원진': {
    name: '어색하고 불편한 날',
    description: '오해가 생기고 불편한 감정이 올라오기 쉬워요.',
    effect: '대인관계에서 오해나 감정적 갈등이 생길 수 있어요. 말조심하고 적당한 거리를 유지하세요.',
    simpleExplanation: '오늘은 "어색하고 불편한" 날이에요. 같은 말도 오해받기 쉬우니 중요한 대화는 다른 날로 미루세요.',
    detailedMeaning: '오늘은 같은 말도 나쁘게 들리고, 사소한 것에도 감정적으로 반응하게 되기 쉬운 날이에요. 오래 참아왔던 불만이 터지거나 관계가 어색해질 수 있어요. 중요한 대화나 갈등 해결은 오늘 하지 마세요. 며칠 지나면 자연스럽게 풀릴 일이에요.',
