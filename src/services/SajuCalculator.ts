...
// Council 검증 (2026-04-18): offset=4는 JDN을 잘못 계산한 주석에 근거한 버그
// 실제 JDN(2026-02-07) = 2,461,079 (이전 주석의 2,461,744는 오타로 665 차이)
// 2461079 % 60 = 59, 실제 일진 임자(壬子) = index 48
// 올바른 offset = (48 - 59 + 60) % 60 = 49
// 교차 검증 4개 케이스 100% 통과:
//   2026-02-07 → 임자, 1980-05-15 → 무자, 1990-12-20 → 기미, 2000-03-10 → 정묘
const JDN_GANJI_OFFSET = 49;
